...
If you're on Windows and have the g++ compiler set up, all you have to do is open the WSU-GLEAM-Team-2 
folder in VSCode and run the default build task, and everything will be compiled and executed, 
and the 3D file made from the sample data will be opened.
